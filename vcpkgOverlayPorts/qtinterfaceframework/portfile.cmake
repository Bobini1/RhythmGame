...
if(CMAKE_HOST_WIN32 AND DEFINED ENV{pythonLocation})
    file(TO_CMAKE_PATH "$ENV{pythonLocation}/python.exe" python3_from_setup_python)
    if(EXISTS "${python3_from_setup_python}")
        set(python_args PYTHON_VERSION "3" PYTHON_EXECUTABLE "${python3_from_setup_python}")
    endif()
endif()
