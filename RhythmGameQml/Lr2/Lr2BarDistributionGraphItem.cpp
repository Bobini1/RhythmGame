...
resolvedImageSource(int specialType,
                    QString rawSource,
                    const QString& chartAssetSource)
{
...
QString
localPathForSource(const QString& source)
{
    if (source.isEmpty()) {
        return {};
    }
...
int
normalizedBlendMode(int rawBlend, bool colorKeyEnabled)
{
...
float
normalizedColor(qreal value)
{
    return static_cast<float>(std::clamp(value, 0.0, 255.0) / 255.0);
}

QPointF
rotatedPoint(const QPointF& point, const QPointF& origin, qreal degrees)
{
...
class DistributionGraphShader : public QSGMaterialShader
{
  public:
    DistributionGraphShader()
    {
        setShaderFileName(
          VertexStage,
          QStringLiteral(":/Lr2/Lr2BarDistributionGraph.vert.qsb"));
        setShaderFileName(
          FragmentStage,
          QStringLiteral(":/Lr2/Lr2BarDistributionGraph.frag.qsb"));
    }
...
{
  public:
    DistributionGraphMaterial() { setFlag(QSGMaterial::Blending, true); }

    ~DistributionGraphMaterial() override { delete m_texture; }
    ...
    {
        const auto* material =
          static_cast<const DistributionGraphMaterial*>(other);
...
bool
DistributionGraphShader::updateUniformData(RenderState& state,
                                           QSGMaterial* newMaterial,
                                           QSGMaterial*)
{
...
void
DistributionGraphShader::updateSampledImage(RenderState&,
                                            int binding,
                                            QSGTexture** texture,
                                            QSGMaterial* newMaterial,
                                            QSGMaterial*)
...
QVariant
Lr2BarDistributionGraphItem::srcData() const
{
    return m_srcData;
}

void
Lr2BarDistributionGraphItem::setSrcData(const QVariant& value)
{
    if (m_srcData == value) {
        return;
    }
...
QObject*
Lr2BarDistributionGraphItem::skinClock() const
{
    return m_skinClock;
}

void
Lr2BarDistributionGraphItem::setSkinClock(QObject* value)
{
...
int
Lr2BarDistributionGraphItem::sourceSkinClockMode() const
{
    return m_sourceSkinClockMode;
}

void
Lr2BarDistributionGraphItem::setSourceSkinClockMode(int value)
{
...
int
Lr2BarDistributionGraphItem::sourceSkinTime() const
{
    return m_sourceSkinTime;
}

void
Lr2BarDistributionGraphItem::setSourceSkinTime(int value)
{
...
int
Lr2BarDistributionGraphItem::sourceTimerFire() const
{
    return m_sourceTimerFire;
}

void
Lr2BarDistributionGraphItem::setSourceTimerFire(int value)
{
...
QVariant
Lr2BarDistributionGraphItem::stateData() const
{
    return m_stateData;
}

void
Lr2BarDistributionGraphItem::setStateData(const QVariant& value)
{
...
int
Lr2BarDistributionGraphItem::sourceGraphType() const
{
    return m_source.graphType;
}

void
Lr2BarDistributionGraphItem::setSourceGraphType(int value)
{
...
int
Lr2BarDistributionGraphItem::sourceSpecialType() const
{
    return m_source.specialType;
}

void
Lr2BarDistributionGraphItem::setSourceSpecialType(int value)
{
...
qreal
Lr2BarDistributionGraphItem::sourceX() const
{
    return m_source.x;
}

void
Lr2BarDistributionGraphItem::setSourceX(qreal value)
{
...
qreal
Lr2BarDistributionGraphItem::sourceY() const
{
    return m_source.y;
}

void
Lr2BarDistributionGraphItem::setSourceY(qreal value)
{
...
qreal
Lr2BarDistributionGraphItem::sourceW() const
{
    return m_source.w;
}

void
Lr2BarDistributionGraphItem::setSourceW(qreal value)
{
...
qreal
Lr2BarDistributionGraphItem::sourceH() const
{
    return m_source.h;
}

void
Lr2BarDistributionGraphItem::setSourceH(qreal value)
{
...
int
Lr2BarDistributionGraphItem::sourceDivX() const
{
    return m_source.divX;
}

void
Lr2BarDistributionGraphItem::setSourceDivX(int value)
{
...
int
Lr2BarDistributionGraphItem::sourceDivY() const
{
    return m_source.divY;
}

void
Lr2BarDistributionGraphItem::setSourceDivY(int value)
{
    const int next = std::max(1, value);
...
QString
Lr2BarDistributionGraphItem::sourcePath() const
{
    return m_sourcePath;
}

void
Lr2BarDistributionGraphItem::setSourcePath(const QString& value)
{
...
QVariantList
Lr2BarDistributionGraphItem::barCells() const
{
    return m_barCellsValue;
}

void
Lr2BarDistributionGraphItem::setBarCells(const QVariantList& value)
{
...
Lr2BarPositionMap*
Lr2BarDistributionGraphItem::barPositionMap() const
{
    return m_barPositionMap;
}

void
Lr2BarDistributionGraphItem::setBarPositionMap(Lr2BarPositionMap* value)
{
...
qreal
Lr2BarDistributionGraphItem::scaleOverride() const
{
    return m_scaleOverride;
}

void
Lr2BarDistributionGraphItem::setScaleOverride(qreal value)
{
...
int
Lr2BarDistributionGraphItem::frameOverrideBase() const
{
    return m_frameOverrideBase;
}

void
Lr2BarDistributionGraphItem::setFrameOverrideBase(int value)
{
...
QColor
Lr2BarDistributionGraphItem::transColor() const
{
    return m_transColor;
}

void
Lr2BarDistributionGraphItem::setTransColor(const QColor& value)
{
...
bool
Lr2BarDistributionGraphItem::colorKeyEnabled() const
{
    return m_colorKeyEnabled;
}

void
Lr2BarDistributionGraphItem::setColorKeyEnabled(bool value)
{
...
QString
Lr2BarDistributionGraphItem::chartAssetSource() const
{
    return m_chartAssetSource;
}

void
Lr2BarDistributionGraphItem::setChartAssetSource(const QString& value)
{
...
QString
Lr2BarDistributionGraphItem::resolvedSource() const
{
    return resolvedImageSource(
      m_source.specialType, m_sourcePath, m_chartAssetSource);
}

void
Lr2BarDistributionGraphItem::loadSourceImage()
{
    m_sourceImage = {};
    m_textureDirty = true;
...
void
Lr2BarDistributionGraphItem::reconnectCells()
{
...
void
Lr2BarDistributionGraphItem::reconnectClock()
{
...
int
Lr2BarDistributionGraphItem::sourceClockSkinTime() const
{
    if (!m_skinClock || m_sourceSkinClockMode == manualClock) {
        return m_sourceSkinTime;
    }
...
Lr2BarDistributionGraphItem::computedFrameOverrideBase() const
{
    ...
    const qreal animTime =
      static_cast<qreal>(sourceClockSkinTime()) - timerFire;
    const qreal msPerFrame =
      static_cast<qreal>(m_source.cycle) / animationGroups;
    ...
    const int group = std::clamp(
      static_cast<int>(std::floor(phase / msPerFrame)), 0, animationGroups - 1);
...
QSGNode*
Lr2BarDistributionGraphItem::updatePaintNode(QSGNode* oldNode,
                                             UpdatePaintNodeData*)
{
    ...
    if (!node) {
        ...
        node->setGeometry(new QSGGeometry(
          graphAttributes(), 0, 0, QSGGeometry::UnsignedIntType));
    ...
    for (int slot = 0; slot < m_barCells.size(); ++slot) {
        ...
        for (int segment = 0; segment < segmentCount; ++segment) {
            const qreal amount =
              graphValueAt(cell, m_source.graphType, segment);
        ...
        for (int segment = 0; segment < segmentCount; ++segment) {
            ...
            const qreal x =
              (rowX + baseX + starts[static_cast<size_t>(segment)]) *
              m_scaleOverride;
            ...
            const int frame = std::clamp(m_frameOverrideBase +
                                           std::min(frameCount - 1, segment),
                                         0,
                                         frameCount - 1);
            ...
            const QPointF rotationOrigin(x + w * anchor.x(),
                                         y + h * anchor.y());
            const QPointF p0 =
              rotatedPoint({ x, y }, rotationOrigin, state.angle);
            const QPointF p1 =
              rotatedPoint({ x + w, y }, rotationOrigin, state.angle);
            const QPointF p2 =
              rotatedPoint({ x + w, y + h }, rotationOrigin, state.angle);
            const QPointF p3 =
              rotatedPoint({ x, y + h }, rotationOrigin, state.angle);

            const quint32 base = static_cast<quint32>(vertices.size());
            const auto appendVertex =
              [&](const QPointF& p, float u, float v, float lu, float lv) {
                  vertices.push_back({
            ...
            appendVertex(
              p0, static_cast<float>(u0), static_cast<float>(v0), 0.0f, 0.0f);
            appendVertex(
              p1, static_cast<float>(u1), static_cast<float>(v0), 1.0f, 0.0f);
            appendVertex(
              p2, static_cast<float>(u1), static_cast<float>(v1), 1.0f, 1.0f);
            appendVertex(
              p3, static_cast<float>(u0), static_cast<float>(v1), 0.0f, 1.0f);
            indices.insert(
              indices.end(),
    ...
    std::memcpy(geometry->vertexData(),
                vertices.data(),
                vertices.size() * sizeof(GraphVertex));
    std::memcpy(
      geometry->indexData(), indices.data(), indices.size() * sizeof(quint32));
