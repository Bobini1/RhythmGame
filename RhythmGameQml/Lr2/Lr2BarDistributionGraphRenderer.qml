        ...
        Lr2BarPositionedItem {
            ...
            Repeater {
                ...
                Loader {
                    ...
                    readonly property real segmentStartX: root.segmentStart(rowDelegate.values,
                                                                            rowDelegate.total,
                                                                            segmentIndex)
                    readonly property real segmentW: root.segmentWidth(rowDelegate.values,
                                                                       rowDelegate.total,
                                                                       segmentIndex)
                    anchors.fill: parent
                    active: segmentW > 0
                    sourceComponent: Component {
                        Lr2SpriteRenderer {
                            ...
                            stateOverride: root.segmentState(segmentLoader.segmentStartX,
                                                             segmentLoader.segmentW)
                            skinTime: 0
                            sourceSkinTime: 0
                            skinClock: null
                            ...
                            frameOverride: Math.min(root.frameCountValue - 1,
                                                    root.frameOverrideBase + segmentLoader.segmentIndex)
                            scaleOverride: root.scaleOverride
