...
TEST_CASE("Parse title", "[BmsChartReader]")
{
    ...
    auto res = charts::readBmsChart(testString, randomGenerator);
...
TEST_CASE("Random blocks get parsed correctly", "[BmsChartReader]")
{
    auto testString =
      "#RANDOM 5\n#IF 5\n#TITLE 44river\n#BPM 120\n#SUBTITLE
testSubTitle\n#GENRE bicior\n#SUBARTIST MC BOBSON\n#ENDIF"s; auto res =
charts::readBmsChart(testString, randomGenerator); REQUIRE(res.tags.title ==
...
TEST_CASE("Nested random blocks", "[BmsChartReader]")
{
    auto testString =
      "#RANDOM 5\n#IF 5\n#TITLE 44river\n#RANDOM 1\n#IF 1\n#ARTIST
-45\n#ENDIF\n#ENDRANDOM\n#ENDIF"s; auto res = charts::readBmsChart(testString,
...
どうか私を殺して下さい -もう、樹海しか見えない-\n   #BPM 166"s; auto CP932String
= boost::locale::conv::from_utf<wchar_t>(testString, "CP932"); auto res =
charts::readBmsChart(CP932String, randomGenerator); auto title =
L"どうか私を殺して下さい -もう、樹海しか見えない-"s; auto artist =
L"LUNEの右手と悠里おねぇちゃんの左脚"s; auto utf8Title =
boost::locale::conv::utf_to_utf<char, wchar_t>(title); auto utf8Artist =
boost::locale::conv::utf_to_utf<char, wchar_t>(artist); REQUIRE(res.tags.title);
