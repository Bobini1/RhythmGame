...
TEST_CASE("Parse notes", "[BmsChartReader]")
{
    ...
    REQUIRE(res.tags.measures[1].p1VisibleNotes[0][0] == "00"s);
}
...
TEST_CASE("Parse notes from a chart with multiple notes", "[BmsChartReader]")
{
    ...
    REQUIRE(res.tags.measures[1].p1VisibleNotes[0][0] == "00"s);
    REQUIRE(res.tags.measures[1].p1VisibleNotes[0][1] == "01"s);
    REQUIRE(res.tags.measures[1].p1VisibleNotes[0][2] == "02"s);
    REQUIRE(res.tags.measures[1].p1VisibleNotes[0][3] == "03"s);
}
...
TEST_CASE("Parse notes from a chart with multiple lanes", "[BmsChartReader]")
{
    ...
    REQUIRE(res.tags.measures[1].p1VisibleNotes[1][0] == "04"s);
    REQUIRE(res.tags.measures[1].p1VisibleNotes[1][1] == "05"s);
    REQUIRE(res.tags.measures[1].p1VisibleNotes[1][2] == "06"s);
    REQUIRE(res.tags.measures[1].p1VisibleNotes[1][3] == "07"s);
}
...
TEST_CASE("Parse all basic note types get", "[BmsChartReader]")
{
    ...
    REQUIRE(res.tags.measures[5].p1VisibleNotes[0][0] == "04"s);
    REQUIRE(res.tags.measures[5].p1VisibleNotes[0][1] == "05"s);
    REQUIRE(res.tags.measures[10].p2VisibleNotes[0].size() == 1);
    REQUIRE(res.tags.measures[10].p2VisibleNotes[0][0] == "00"s);
    REQUIRE(res.tags.measures[999].p1InvisibleNotes[4].size() == 3);
    REQUIRE(res.tags.measures[999].p1InvisibleNotes[4][0] == "12"s);
    REQUIRE(res.tags.measures[999].p1InvisibleNotes[4][1] == "34"s);
    REQUIRE(res.tags.measures[999].p1InvisibleNotes[4][2] == "56"s);
    REQUIRE(res.tags.measures[888].p2InvisibleNotes[3].size() == 1);
    REQUIRE(res.tags.measures[888].p2InvisibleNotes[3][0] == "01"s);
    REQUIRE(res.tags.measures[777].p1LongNotes[2].size() == 1);
    REQUIRE(res.tags.measures[777].p1LongNotes[2][0] == "10"s);
    REQUIRE(res.tags.measures[666].p2LongNotes[1].size() == 1);
    REQUIRE(res.tags.measures[666].p2LongNotes[1][0] == "11"s);
}
