...
if (NOT normalized_test_binary_root MATCHES
        "/web-gameplay-core-negative-contracts$")
    message(FATAL_ERROR
            "TEST_BINARY_ROOT must end in "
            "web-gameplay-core-negative-contracts before recursive cleanup")
endif ()

set(fixture_source
        "${SOURCE_ROOT}/test/cmake/web_gameplay_core_contract")
...
message(STATUS
        "Portable gameplay negative dependency contracts passed")
