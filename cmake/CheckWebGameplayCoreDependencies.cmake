...
set(forbidden_dependency_pattern
        "/(resource_managers/(vars|profile)[.]h|gameplay_logic/chartrunner[.]h|qml_components/bga[.]h|sounds/(audioengine|miniaudiobackend)[.]h|db/sqlitecppdb[.]h|sqlitecpp/|qtmultimedia/|wil/|llfio|miniaudio[.]h)"
)
...
foreach (deps_line IN LISTS deps_lines)
    ...
    if (normalized_dependency MATCHES "${forbidden_dependency_pattern}")
        message(FATAL_ERROR
                "Portable gameplay target ${TARGET_NAME} has forbidden "
                "active include dependency: ${absolute_dependency_path}")
    endif ()
endforeach ()
